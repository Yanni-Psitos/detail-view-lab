...
public class ShoppingSQLiteOpenHelper extends SQLiteOpenHelper{
    ...
    public static final String COL_ITEM_EXTRADETAIL = "EXTRA";

    public static final String[] SHOPPING_COLUMNS = {COL_ID,COL_ITEM_NAME,COL_ITEM_DESCRIPTION,COL_ITEM_PRICE,COL_ITEM_TYPE,COL_ITEM_EXTRADETAIL};
    ...
    public long addItem(String name, String description, String price, String type, String extra){
        ContentValues values = new ContentValues();
        values.put(COL_ITEM_NAME, name);
        values.put(COL_ITEM_DESCRIPTION, description);
        values.put(COL_ITEM_PRICE, price);
        values.put(COL_ITEM_TYPE, type);
        values.put(COL_ITEM_EXTRADETAIL, extra);
    ...
    public Cursor searchShoppingListId(int id){
        SQLiteDatabase db = this.getReadableDatabase();
